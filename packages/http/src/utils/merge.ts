// biome-ignore-all lint: false

import { isObject } from "@repo/shared/utils/object"
import { supportsAbortSignal } from "#/constants"
import type { Hooks } from "#/types/hook"
import type { HttpHeadersInit, Options } from "#/types/option"
...
export const mergeHeaders = (source1: HttpHeadersInit = {}, source2: HttpHeadersInit = {}) => {
...
function newHookValue<K extends keyof Hooks>(
	original: Hooks,
	incoming: Hooks,
	property: K
): Required<Hooks>[K] {
			...
			for (let [key, value] of Object.entries(source)) {
				...
				if (key === "context") {
					...
					returnValue = {
						...returnValue,
						context:
							value === undefined || value === null ? {} : { ...returnValue.context, ...value },
					}
					continue
				}
